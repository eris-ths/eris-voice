...
- **将来的に RAG の Vector Search にも応用可能** (ShareMind Embeddings 2 路線)
...
ShareMind の Gemini Embedding 2 (3072次元) の圧縮にも直接応用可能。
...
- ShareMind ctx: `data/ctx/projects/sharemind_gcp_migration_resume.md` (Phase E)
